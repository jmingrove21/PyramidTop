<?php
    function store_info($json_data){
        ...
        $query = "SELECT storemaster_num, store_name, storemaster_name, store_address, start_time, end_time, store_restday, store_notice FROM STORE AS s WHERE s.store_id='".$id."' AND s.store_pw='".$pw."'";
