<?php
    ...
    include "../db.php";
        ...
        $count=$json_data['user_count'];
         ...
         $query="
         SELECT so.store_serial,store_name, store_branch_name,store_address_jibun,store_profile_img,minimum_order_price,order_create_date,order_number,( 6371 * acos( cos( radians(".$user_lat.") ) * cos( radians( store_latitude) )
