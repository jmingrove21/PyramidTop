<?php
    function store_login($json_data){
        ...
        $query1 = "SELECT m.store_master_num, s.store_name, s.store_serial, s.store_branch_name FROM store_master AS m INNER JOIN store AS s ON m.store_serial=s.store_serial WHERE m.store_master_id='".$id."' AND m.store_master_password='".$pw."'";
        ...
        $send_data=array(
            ...
            'store_branch_name'=>$result1['store_branch_name']
        );
